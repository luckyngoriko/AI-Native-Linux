...
| Phase tag | S1.3                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| Layer     | L2 AIOS-FS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| Consumes  | **Imports vocabulary from**: L0 evidence/status (closed enums), S0.1 action envelope (type-level), S1.2 privacy class (type-level). **Peer (intra-L2)**: companion `03_conflict_resolution.md`. **Lower-numbered runtime substrate**: L1 host/recovery substrate (legitimate downward dependency). **Body-text references** (informational, not Consumes-level dependencies): L4 subject canonical-id (vocabulary import), L9 evidence-projection (L9 reads from L2 — inverse direction is fine), L6 sandbox composition (vocabulary import). |
