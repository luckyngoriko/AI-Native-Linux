...
| Consumes       | S7.1 (Surface + Composition; KDE column of §4.3 mapping), S7.2 (Shared UI Schema; closed `NodeKind` 19 values), S7.3 (Visual Language; KDE mapping in §8.1), S8.2 (GPU Resource Model; per-group `VkDevice`, dmabuf brokering), S5.1 (identity; recovery-mode flag), L0 INV-019..INV-022 (constitutional visual obligations) |
