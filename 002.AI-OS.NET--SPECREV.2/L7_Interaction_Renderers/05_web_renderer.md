...
| Consumes       | S7.1 (Surface + Composition), S7.2 (Shared UI Schema), S7.3 (Visual Language), S8.2 (GPU Resource Model — per-origin `GPUAdapter`), S5.1 (identity, recovery mode), L0 INV-006 (web localhost default), INV-019..INV-022 (visual identity / chrome / AI distinction / recovery aesthetic)                          |
